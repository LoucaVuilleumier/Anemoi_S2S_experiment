...
# The job name
#SBATCH --job-name=inference_8M_AIFS_dailymeans_2007-2009

# Set the initial working directory
#SBATCH --chdir=/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment

# Set the error and output files
#SBATCH --output=./slurm_scripts/output_slurm/inference_8M_AIFS_dailymeans-lr_0.625e-6_2007-2009.out
#SBATCH --error=./slurm_scripts/output_slurm/inference_8M_AIFS_dailymeans-lr_0.625e-6_2007-2009.out
...
CONFIG_FILE="/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment/Configs_new_2026_16_02/Inference/inference_aifs_daily_means_3-0-freq.yaml"

# Automatically generate all first, the 15th from 2007-2009 for July
...
for year in {2007..2009}; do
    for month in 7; do
        ...
        OUTPUT_DIR="/ec/res4/scratch/nld4584/Anemoi_S2S_experiment/output_inference/DailyMeans-3-0-freq/aifs-subs-pretrain-${first_day}"
        mkdir -p ${OUTPUT_DIR}
        ...
        OUTPUT_DIR="/ec/res4/scratch/nld4584/Anemoi_S2S_experiment/output_inference/DailyMeans-3-0-freq/aifs-subs-pretrain-${fifteenth}"
        mkdir -p ${OUTPUT_DIR}
        OUTPUT_FILE="${OUTPUT_DIR}/member-${SLURM_ARRAY_TASK_ID}.nc"
        export INFERENCE_OUTPUT_PATH=${OUTPUT_FILE}
        export INFERENCE_DATE=${BASE_DATE}
