...
# The job name
#SBATCH --job-name=inference_8M_AIFS_2007-2009

# Set the initial working directory
#SBATCH --chdir=/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment

# Set the error and output files
#SBATCH --output=./slurm_scripts/output_slurm/inference_8M_AIFS_2007-2009.out
#SBATCH --error=./slurm_scripts/output_slurm/inference_8M_AIFS_2007-2009.out
