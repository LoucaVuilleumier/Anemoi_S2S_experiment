...
#SBATCH --output=./slurm_scripts/output_slurm/finetuning_weekly_means-10K-%J.out
#SBATCH --error=./slurm_scripts/output_slurm/finetuning_weekly_means-10K-%J.out
