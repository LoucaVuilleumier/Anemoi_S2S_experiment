...
# The job name
#SBATCH --job-name=run_12_inference_runs_10k_additional_training_default

# Set the initial working directory
#SBATCH --chdir=/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment

# Set the error and output files
#SBATCH --output=./slurm_scripts/output_slurm/run_12_inference_runs_10k_additional_training_default-%J.out
#SBATCH --error=./slurm_scripts/output_slurm/run_12_inference_runs_10k_additional_training_default-%J.out
...
CHECKPOINT_PATH="/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment/output_training/checkpoint/26f8372356c945bdb1162898a708e0a0/last.ckpt"
...
for i in {0..11}; do
    ...
    OUTPUT_FILE="${OUTPUT_DIR}/output_inference_10k_default_8weeks_run$(printf "%02d" $i)_${INFERENCE_DATE:0:10}.nc"
