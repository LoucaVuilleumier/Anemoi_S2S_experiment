...
# The job name
#SBATCH --job-name=inference_8M_AIFS_weeklymeans_2007-2009-27-0-freq

# Set the initial working directory
#SBATCH --chdir=/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment

# Set the error and output files
#SBATCH --output=./slurm_scripts/output_slurm/inference_8M_AIFS_weeklymeans_2007-2009-27-0-freq.out
#SBATCH --error=./slurm_scripts/output_slurm/inference_8M_AIFS_weeklymeans_2007-2009-27-0-freq.out
...
for year in {2007..2009}; do
 ...
 # Find the first day of the month
        ...
        OUTPUT_DIR="/ec/res4/scratch/nld4584/Anemoi_S2S_experiment/output_inference/WeeklyMeans-27-0-freq/aifs-subs-pretrain-${first_day}"
        mkdir -p ${OUTPUT_DIR}
        ...
        OUTPUT_DIR="/ec/res4/scratch/nld4584/Anemoi_S2S_experiment/output_inference/WeeklyMeans-27-0-freq/aifs-subs-pretrain-${fifteenth}"
        mkdir -p ${OUTPUT_DIR}
        OUTPUT_FILE="${OUTPUT_DIR}/member-${SLURM_ARRAY_TASK_ID}.nc"
        export INFERENCE_OUTPUT_PATH=${OUTPUT_FILE}
        export INFERENCE_DATE=${BASE_DATE}
