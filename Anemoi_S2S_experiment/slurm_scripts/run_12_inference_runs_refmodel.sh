...
# The job name
#SBATCH --job-name=run_12_inference_runs

# Set the initial working directory
#SBATCH --chdir=/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment

# Set the error and output files
#SBATCH --output=./slurm_scripts/output_slurm/run_12_inference_runs-%J.out
#SBATCH --error=./slurm_scripts/output_slurm/run_12_inference_runs-%J.out
...
CONFIG_FILE="/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment/Configs_new/Inference/inference_refmodel_8weeks_12runs_summer2022.yaml"
...
for i in {0..11}; do
    ...
    OUTPUT_FILE="${OUTPUT_DIR}/output_inference_refmodel_8weeks_run$(printf "%02d" $i)_${INFERENCE_DATE:0:10}.nc"
