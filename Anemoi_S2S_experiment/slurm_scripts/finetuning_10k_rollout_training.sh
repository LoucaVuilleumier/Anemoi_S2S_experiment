...
# The job name
#SBATCH --job-name=finetuning_10k_rollout_training

# Set the initial working directory
#SBATCH --chdir=/ec/res4/hpcperm/nld4584/Anemoi_S2S_experiment

# Set the error and output files
#SBATCH --output=./slurm_scripts/output_slurm/finetuning_10k_rollout_training-%J.out
#SBATCH --error=./slurm_scripts/output_slurm/finetuning_10k_rollout_training-%J.out
...
srun anemoi-training train --config-name=finetuning_10k_rollout_training.yaml